...
from sqlhelpers.locks_sql import update_lock, is_locked, get_locks
from telethon import events
from telethon.tl import functions, types
from userbot import syntax


@bot.on(command("lock( (?P<target>\S+)|$)"))
async def _(event):
...
@bot.on(command("curenabledlocks"))
async def _(event):
    if event.fwd_from:
        return
    res = ""
