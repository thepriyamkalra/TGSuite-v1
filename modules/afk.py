...
async def on_afk(event):
    ...
    if client.storage.USER_AFK and not (await event.get_sender()).bot:
        ...
        message_to_reply = f"**My master is AFK since** {afk_since} " + \
            f"**cuz {reason}, feel free to chat with me as long as you like, but i'll keep repeating myself tho.**" \
            if reason \
            else f"**My master is AFK since** {afk_since}, feel free to chat with me as long as you like, but i'll keep repeating myself tho."
